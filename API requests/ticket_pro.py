        ...
        if data.get("success"):
            ...
            if flights:
                ...
                for flight in flights:
                    print(f"  Origin City (IATA): {flight['origin']}")
                    print(f"  Destination City (IATA): {flight['destination']}")
                    ...
                    print(f"  Airline (IATA): {flight['airline']}")
                    print(f"  Flight Number: {flight['flight_number']}")
                    print(f"  Departure Date and Time: {flight['departure_at']}")
                    print(f"  Number of Transfers: {flight['transfers']}")
                    print(f"  Duration (to destination) in minutes: {flight['duration_to']}")
